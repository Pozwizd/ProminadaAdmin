...
public interface InvestorPropertySpecification {

    static Specification<InvestorProperty> search(PropertiesFilter filter) {
        return (root, query, criteriaBuilder) -> {
            List<Predicate> predicates = new ArrayList<>();
            Join<InvestorProperty, InvestorPropertyMain> mainJoin = root.join("investorPropertyMain", JoinType.LEFT);
    ...
    private static void addLastCommunicationPredicate(List<Predicate> predicates, PropertiesFilter filter,
                                                      Join<InvestorProperty, InvestorPropertyMain> mainJoin,
                                                      CriteriaBuilder criteriaBuilder) {
    ...
    public static Specification<InvestorProperty> hasPhotos() {
        return (root, query, criteriaBuilder) ->
                criteriaBuilder.isNotEmpty(root.get("investorPropertyGalleryImages"));
    }

    public static Specification<InvestorProperty> isAdvertising() {
        return (root, query, criteriaBuilder) -> {
            Join<InvestorProperty, InvestorPropertyMain> mainJoin = root.join("investorPropertyMain", JoinType.LEFT);
    ...
    public static Specification<InvestorProperty> byRealtor(Long realtorId) {
        return (root, query, criteriaBuilder) ->
                criteriaBuilder.equal(root.get("realtor").get("id"), realtorId);
    }

    public static Specification<InvestorProperty> createdAfter(LocalDate date) {
        return (root, query, criteriaBuilder) ->
